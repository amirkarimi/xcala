...
case class QueryOptions(page: Int = 1, pageSizeOpt: Option[Int] = None, override val sortExpression: Option[String] = None) extends SortOptionsBase[QueryOptions](sortExpression) {
