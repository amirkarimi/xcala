...
//
//  def setFileFolder(file: ReadFile[BSONValue], folderId: Option[BSONObjectID]): Future[Option[WriteResult]] = folderId match {
...
//  }
//
//  def setFileAsHidden(file: ReadFile[BSONValue]): Future[Option[WriteResult]] = {
//    gridFS.files.update(
//      BSONDocument("_id" -> file.id),
...
//  }
//
//  def removeFolder(id: BSONObjectID): Future[WriteResult] = removeFolder(BSONDocument("_id" -> id))
//
//  def removeFolder(query: BSONDocument): Future[WriteResult] = {
